...
export declare class CustomerBookingController {
    private readonly bookingService;
    constructor(bookingService: BookingService);
    createDirectBooking(userId: string, dto: DirectBookingDto): Promise<{
        job: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    getActiveBookings(userId: string): Promise<({
        job: {
            category: {
                id: string;
                name: string;
    ...
    confirmCompletion(userId: string, bookingId: string): Promise<{
        message: string;
        bookingId: string;
        jobId: string;
    }>;
