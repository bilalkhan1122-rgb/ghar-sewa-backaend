...
export declare class CustomerDisputesController {
    private readonly disputesService;
    constructor(disputesService: DisputesService);
    raise(userId: string, dto: RaiseDisputeDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    list(userId: string, query: DisputeQueryDto): Promise<{
        data: ({
            booking: {
                id: string;
    ...
    getHistory(userId: string, id: string): Promise<({
        actor: {
            id: string;
            fullName: string;
            role: UserRole;
    ...
    uploadEvidence(userId: string, id: string, file: Express.Multer.File): Promise<{
        id: string;
        createdAt: Date;
        disputeId: string;
        uploaderId: string;
    ...
    respond(userId: string, id: string, dto: RespondDisputeDto): Promise<{
        id: string;
        createdAt: Date;
        description: string | null;
        disputeId: string;
