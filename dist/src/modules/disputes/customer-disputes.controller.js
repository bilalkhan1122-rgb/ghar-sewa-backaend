...
exports.CustomerDisputesController = void 0;
...
const raise_dispute_dto_1 = require("./dtos/raise-dispute.dto");
const dispute_query_dto_1 = require("./dtos/dispute-query.dto");
const respond_dispute_dto_1 = require("./dtos/respond-dispute.dto");
let CustomerDisputesController = class CustomerDisputesController {
    disputesService;
...
exports.CustomerDisputesController = CustomerDisputesController;
__decorate([
    (0, common_1.Post)('/'),
    ...
    __metadata("design:paramtypes", [String, raise_dispute_dto_1.RaiseDisputeDto]),
    __metadata("design:returntype", Promise)
], CustomerDisputesController.prototype, "raise", null);
__decorate([
    (0, common_1.Get)('/'),
    (0, swagger_1.ApiOperation)({ summary: 'List my disputes (paginated, filter by status)' }),
    __param(0, (0, get_user_decorator_1.GetUser)('sub')),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dispute_query_dto_1.DisputeQueryDto]),
    __metadata("design:returntype", Promise)
], CustomerDisputesController.prototype, "list", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], CustomerDisputesController.prototype, "get", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], CustomerDisputesController.prototype, "getHistory", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomerDisputesController.prototype, "uploadEvidence", null);
__decorate([
    (0, common_1.Post)('/:id/response'),
    (0, swagger_1.ApiOperation)({ summary: 'Respond to the dispute / admin questions' }),
    __param(0, (0, get_user_decorator_1.GetUser)('sub')),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    ...
    __metadata("design:returntype", Promise)
], CustomerDisputesController.prototype, "respond", null);
exports.CustomerDisputesController = CustomerDisputesController = __decorate([
    (0, swagger_1.ApiTags)('Disputes (Customer)'),
...
//# sourceMappingURL=customer-disputes.controller.js.map