...
const admin_verification_controller_1 = require("./admin-verification.controller");
...
exports.VerificationModule = VerificationModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [provider_verification_controller_1.ProviderVerificationController, admin_verification_controller_1.AdminVerificationController],
        providers: [verification_service_1.VerificationService, admin_audit_service_1.AdminAuditService],
